...
def evaluate_results_for_debug(config, fluency_obj, evaluation_results, gts_data, results_dir, factual_captions,
...
def main():
    ...
    for d in os.listdir(dir_path):
        ...
        res_file = ''
        with open(os.path.join(dir_path, d, 'config.yaml')) as f:
