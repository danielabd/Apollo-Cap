...
def train(model, train_data, val_data, learning_rate, epochs, labels_dict, batch_size, desired_cuda_num,
          path_for_saving_last_model, path_for_saving_best_model):
...
def main():
    ...
    for i, label in enumerate(
            list(set(list(df_train['category']) + list(df_val['category']) + list(df_test['category'])))):
        labels_dict[label] = i
