...
class CLIPTextGenerator:
    ...
    def run(self, image_features, cond_text, beam_size, cuda_idx, sentiment_type = None, sentiment_scale = None, text_style_scale = None,text_to_mimic = None,desired_style_embedding_vector = None,style_type = None):
