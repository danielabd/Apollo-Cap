...
def get_args():
    parser.add_argument('--config_file', type=str,
                        ...
                        default=os.path.join('.', 'configs', 'config_update_vit.yaml'),
    ...
    for img_path_idx, img_path in enumerate(imgs_to_test):  # img_path_list:
        ...
        if not config['debug_mac']:
            if config['update_ViT']:
                ...
                image_features = text_generator.get_img_feature([img_path], None, return_k_v=False, get_preroccessed_img=True)
        else:
            image_features = None
