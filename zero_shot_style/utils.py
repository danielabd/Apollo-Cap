...
parser.add_argument('--data_name', type=str, default='Twitter', help='data to use')
...
parser.add_argument('--config_file', type=str, default=os.path.abspath(os.path.realpath(__file__),'configs','default_config.yaml'), help='full path to config file')
parser.add_argument('--test_param', type=str, default="default argsparse", help='test params priority')
