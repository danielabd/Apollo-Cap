...
#parser.add_argument('--data_dir', type=str, default=os.path.join(os.path.expanduser('~'), 'zero-shot-style', 'zero_shot_style', 'data'), help='data path')
...
# parser.add_argument('--config_file', type=str, default=os.path.join(os.path.expanduser('~'), 'zero-shot-style', 'zero_shot_style', 'configs','default_config.yaml'), help='full path to config file')
# parser.add_argument('--config_file', type=str, default=os.path.join(os.path.expanduser('~'), 'zero-shot-style', 'zero_shot_style', 'configs','emotions_config.yaml'), help='full path to config file')
#parser.add_argument('--config_file', type=str, default=os.path.join(os.path.expanduser('~'), 'zero-shot-style', 'zero_shot_style', 'configs','emotions_config_all_classes.yaml'), help='full path to config file')
# parser.add_argument('--config_file', type=str, default=os.path.join(os.path.expanduser('~'), 'zero-shot-style', 'zero_shot_style', 'configs','twitter_config.yaml'), help='full path to config file')
parser.add_argument('--config_file', type=str, default=os.path.join(os.path.expanduser('~'), 'zero-shot-style', 'zero_shot_style', 'configs','flickrstyle10k_config.yaml'), help='full path to config file')
