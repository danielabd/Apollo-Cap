...
parser.add_argument('--results_dir', type=str, default=os.path.join(os.path.expanduser('~'), 'projects', 'zero-shot-style', 'results'), help='results path')
parser.add_argument('--checkpoints_dir', type=str, default=os.path.join(os.path.expanduser('~'), 'projects', 'zero-shot-style', 'checkpoints'), help='checkpoints path')
...
parser.add_argument('--data_dir', type=str, default=os.path.join(os.path.expanduser('~'), 'projects', 'zero-shot-style', 'data', 'flickrstyle10k'), help='data path')
...
# parser.add_argument('--config_file', type=str, default=os.path.join(os.path.expanduser('~'), 'projects', 'zero-shot-style', 'zero_shot_style', 'configs','default_config.yaml'), help='full path to config file')
# parser.add_argument('--config_file', type=str, default=os.path.join(os.path.expanduser('~'), 'projects', 'zero-shot-style', 'zero_shot_style', 'configs','emotions_config.yaml'), help='full path to config file')
#parser.add_argument('--config_file', type=str, default=os.path.join(os.path.expanduser('~'), 'projects', 'zero-shot-style', 'zero_shot_style', 'configs','emotions_config_all_classes.yaml'), help='full path to config file')
parser.add_argument('--config_file', type=str, default=os.path.join('.', 'configs','twitter_config.yaml'), help='full path to config file')
#parser.add_argument('--config_file', type=str, default=os.path.join(os.path.expanduser('~'), 'projects', 'zero-shot-style', 'zero_shot_style', 'configs','flickrstyle10k_config.yaml'), help='full path to config file')
